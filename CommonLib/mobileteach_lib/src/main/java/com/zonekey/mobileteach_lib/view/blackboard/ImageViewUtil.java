...
public class ImageViewUtil {
    ...
    public static Rect getBitmapRectCenterInside(int width, int height, View view) {
        final int viewWidth = view.getWidth();
        final int viewHeight = view.getHeight();

        return getBitmapRectCenterInsideHelper(width, height, viewWidth, viewHeight);
    }
    ...
    private static Rect getBitmapRectCenterInsideHelper(int bitmapWidth,
        ...
        LogUtil.e("ImageView", "left" + result.left + "right" + result.right + "top" + result.top + "bottom" + result.bottom);
        return result;
    }
}
