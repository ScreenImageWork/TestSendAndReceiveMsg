...
public class MobileTeachApi {
    ...
    public class PresentControl {
        ...
        public static final short Request_ShapeScale =  0x99; //缩放聚光灯
    ...
    public class RECORD {   //录屏指令
        ...
        public static final String Stream_Parameters = "StreamType=H264VideoFrame&frameRate=-1";
    }
    ...
    public class FILE_LIST {
        ...
        public static final short Request_OpenFileInCurrentFolder = 0x03;       //打开电脑本地某个文件
        //已上传
