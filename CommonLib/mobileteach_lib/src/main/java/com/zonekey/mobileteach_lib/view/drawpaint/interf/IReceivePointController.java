...
public interface IReceivePointController {
    void newShape(ReceiverInfo receiverInfo, TransPointF transPointF, ArrayList<LineInfo> lists);   //增加新图形

    void addPoint(ReceiverInfo receiverInfo, TransPointF transPointF, ArrayList<LineInfo> lists);   //追加点

    void endDrawing(ReceiverInfo receiverInfo, TransPointF transPointF, ArrayList<LineInfo> lists); //结束一笔绘制
