...
import com.zonekey.mobileteach_lib.interf.OnAppQuitListener;
...
public class MobileTeach {
    ...
    public static void init(final Application application, int CURRENT_APP) {
        ...
        if (CURRENT_APP == MobileTeachConfig.App_Teachmaster) {
        ...
        } else if (CURRENT_APP == MobileTeachConfig.App_MobileTeach_Teacher) {
        ...
        } else if (CURRENT_APP == MobileTeachConfig.App_MobileTeach_Student) {
