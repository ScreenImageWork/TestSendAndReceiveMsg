...
import com.zonekey.mobileteach_lib.util.Constant;
...
import com.zonekey.mobileteach_lib.view.drawpaint.PaintImageView;
import com.zonekey.mobileteach_lib.view.laserpen.LaserPenView;
        ...
        mPenGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (i == R.id.rb_b_pen_min) {
                    mPaintImageView.setStrokeWidth(PaintConfig.mStartSize);
                } else if (i == R.id.rb_b_pen_middle) {
                    mPaintImageView.setStrokeWidth(PaintConfig.mMiddleSize);
                } else if (i == R.id.rb_b_pen_max) {
                    mPaintImageView.setStrokeWidth(PaintConfig.mMaxSize);
                }
            }
        });
