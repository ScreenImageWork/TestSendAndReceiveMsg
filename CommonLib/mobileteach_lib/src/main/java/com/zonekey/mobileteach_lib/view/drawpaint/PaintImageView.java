...
public class PaintImageView extends AppCompatImageView implements OnDrawListener, IState, IPaint {
    ...
    private PaintTouchListener mTouchListener;
    ...
    public interface PaintTouchListener {
        void start();

        void end();
    }

    public void setPaintTouchListener(PaintTouchListener listener) {
