package com.zonekey.mobileteach_lib.view.drawpaint.bean.shape;

import android.graphics.PointF;
import android.os.Parcel;
import android.os.Parcelable;

import com.zonekey.mobileteach_lib.view.drawpaint.interf.IShape;
 ...
 * 绘画的每一条直线的对象
 */
public class LineInfo implements Parcelable ,IShape {
